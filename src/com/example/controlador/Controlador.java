...
public class Controlador // NOTA: REVISAR BIEN LOS METODOS DEL
// CONTROLADOR....PENSAR BIEN EN SU VERDADERA
// FUNCIONALIDAD!
{

	static public String insertarProfesor(Context context, String idP,
			String usuario, String contrasena, String nombre, String apellido)// DEPRECATED,
																				// despues
																				// se
																				// usara
																				// el
																				...
																				// profesor
	{
		...
		;
		String[] params = new String[] { "" + idP, usuario, contrasena, nombre,
				apellido };
	...
	static public String insertarComentario(Context context, String idCom,
			String iidH, String fecha, String comentario)// CUANDO MANEJE ESTO
															// COMO OBJETO PUEDO
															// INTERPRETAR EL
															// fecha COMO UN
															// CALENDAR :)
